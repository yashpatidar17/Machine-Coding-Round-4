...
export const Forum = () => {
  const {  upvoteHandler, downvoteHandler,sortedData,bookMarkHandler } = useContext(DataContext);
      ...
      {sortedData.map((post) => (
        <div key={post.postId} className="post-card-container">
          ...
          <div className="post-card-container-second">
            ...
            <Link key={post.postId} to={`/post/${post.postId}`}><ModeCommentRoundedIcon /></Link>
              <ShareRoundedIcon />
